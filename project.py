...
class OnlineSalesRegisterCollector:
    ...
    def total_tax(self):
        total_tax_summ=self.ten_percent_tax_calculation()+self.twenty_percent_tax_calculation()
        return total_tax_summ
    ...
    def get_telephone_number(telephone_number):
        ...
        else: return f'+7 {telephone_number}'